                ...
                <div class="card card-outline card-primary elevation-2" style="border-top: 3px solid #4b5e82;">
                    ...
                    <div class="card-body p-4">
                        <form action="{{ route('register.store') }}" method="POST" id="registerForm">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="nombre" id="nombre" class="form-control @error('nombre') is-invalid @enderror" placeholder="Nombre Completo" value="{{ old('nombre') }}" required>
                                            @error('nombre')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" name="numero_documento" id="numero_documento" class="form-control @error('numero_documento') is-invalid @enderror" placeholder="Número de Documento" value="{{ old('numero_documento') }}" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="tel" name="numero_telefono" id="numero_telefono" class="form-control @error('numero_telefono') is-invalid @enderror" placeholder="Número de Teléfono" value="{{ old('numero_telefono') }}" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="email" name="correo" id="correo" class="form-control @error('correo') is-invalid @enderror" placeholder="Correo Electrónico" value="{{ old('correo') }}" required>
                                            @error('correo')
                                                <span class="invalid-feedback d-block">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <select name="grupo" id="grupo_id" class="form-control @error('grupo') is-invalid @enderror" required>
                                                <option value="">Seleccione el Tecnologo</option>
                                                @if(isset($grupos))
                                                    @foreach($grupos as $grupo)
                                                        <option value="{{ $grupo->id }}" {{ old('grupo') == $grupo->id ? 'selected' : '' }}>{{ $grupo->nombre }}</option>
                                                    @endforeach
                                                @else
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <select name="fichas" id="ficha_id" class="form-control @error('fichas') is-invalid @enderror" required>
                            ...
                            <button type="submit" class="btn btn-primary btn-block mt-3" style="background: #4b5e82; border: none;" id="submitBtn"><i class="fas fa-save mr-1"></i> Registrar Aprendiz</button>
                        </form>
...
<script>
    $(document).ready(function () {
        ...
        $('.nav-sidebar a[href="{{ route('register.create') }}"]').addClass('active').parents('.nav-item.has-treeview').addClass('menu-open');
            ...
            if (value.length > 0) {
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.exists) {
                            numeroDocumentoError.text('Este número de documento ya está registrado.').removeClass('d-none');
                    ...
                    error: function () {
                        numeroDocumentoError.text('Error al verificar el número de documento.').removeClass('d-none');
                        $('#numero_documento').addClass('is-invalid');
                        isNumeroDocumentoValid = false;
