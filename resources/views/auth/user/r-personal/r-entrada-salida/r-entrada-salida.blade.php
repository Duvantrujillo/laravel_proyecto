                ...
                <div class="col-md-10">
                    <div class="card card-outline card-primary elevation-2" style="border-top: 3px solid #4b5e82;">
                        <div class="card-header bg-transparent border-0">
                            <h3 class="card-title text-dark"><i class="fas fa-door-open mr-2"></i> Registrar entrada</h3>
                        </div>
                        <div class="card-body p-4">
                            <form id="entradaSalidaForm" action="{{ route('entrada_salida.store') }}" method="POST">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select name="ficha" id="ficha"
                                                class="form-control @error('ficha') is-invalid @enderror" required>
                                ...
                                <div class="row mb-3 align-items-end">
                                    <div class="col-md-6">
                                        <label for="fechaEntradaGlobal" class="d-block text-dark">Fecha Entrada
                                            Global</label>
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text bg-light"><i
                                            ...
                                            <input type="datetime-local" id="fechaEntradaGlobal" class="form-control"
                                                value="">
                                        </div>
                                        <button type="button" id="aplicarFechaGlobal"
                                            class="btn btn-outline-primary btn-block mt-2"><i class="fas fa-clock mr-1"></i>
                                            Aplicar Fecha</button>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <button type="button" id="aplicarVisitoGlobal"
                                            class="btn btn-outline-primary btn-block mt-2"><i class="fas fa-check mr-1"></i>
                                            Aplicar Visitó</button>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-3">
                                    <div class="col-md-4">
                                        <button type="button" id="seleccionarTodosBtn"
                                            class="btn btn-outline-info btn-block"><i class="fas fa-users mr-1"></i>
                                            Seleccionar Todos</button>
                                    </div>
                                    <div class="col-md-4">
                                        <button type="button" id="seleccionarTodasFechasBtn"
                                            class="btn btn-outline-info btn-block"><i
                                                class="fas fa-calendar-check mr-1"></i> Sel. Todas Fechas</button>
                                    </div>
                                    <div class="col-md-4">
                                        <button type="button" id="seleccionarTodosVisitoBtn"
                                            class="btn btn-outline-info btn-block"><i class="fas fa-tractor mr-1"></i> Sel.
                                            Todos Visitó</button>
                                    </div>
                                </div>
                                        ...
                                        <thead class="bg-light">
                                            <tr>
                                                <th class="text-center" style="width: 50px;">
                                                    <input type="checkbox" id="seleccionarTodosUsuarios"
                                                        title="Seleccionar todos los usuarios">
                                                </th>
                                                <th>Nombre</th>
                                                <th class="text-center">
                                                    Fecha Entrada
                                                    <input type="checkbox" id="seleccionarTodasFechas"
                                                        title="Seleccionar todas las fechas">
                                                </th>
                                                <th class="text-center">
                                                    Visitó Granja
                                                    <input type="checkbox" id="seleccionarTodosVisito"
                                                        title="Seleccionar todos los visitó">
                                                </th>
                                            </tr>
                                        </thead>
                                ...
                                <button type="submit" class="btn btn-primary btn-block"
                                    style="background: #4b5e82; border: none;"><i class="fas fa-save mr-1"></i> Registrar
...
@section('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const seleccionarTodosVisitoBtnText = seleccionarTodosVisitoBtn.querySelector('span') ||
                seleccionarTodosVisitoBtn;
                    ...
                    fetch(`/get-usuarios-por-ficha?ficha=${fichaId}`)
                        ...
                        .then(data => {
                            ...
                            `;
                                ...
                                const selectedCheckbox = row.querySelector(
                                    'input[name$="[selected]"]');
                                const fechaCheckbox = row.querySelector(
                                    'input[name$="[fecha_selected]"]');
                                const visitoCheckbox = row.querySelector(
                                    'input[name$="[visito_selected]"]');
                                const entradaInput = row.querySelector(
                                    'input[type="datetime-local"]');
                                const visitoSelect = row.querySelector('select');

                                selectedCheckbox.addEventListener('change', function() {
                                    const isChecked = this.checked;
                                    entradaInput.disabled = !isChecked || !fechaCheckbox
                                        .checked;
                                    visitoSelect.disabled = !isChecked || !
                                        visitoCheckbox.checked;
                                });

                                fechaCheckbox.addEventListener('change', function() {
                                    entradaInput.disabled = !selectedCheckbox.checked ||
                                        !this.checked;
                                });

                                visitoCheckbox.addEventListener('change', function() {
                                    visitoSelect.disabled = !selectedCheckbox.checked ||
                                        !this.checked;
                                });
                            });
            ...
            seleccionarTodosUsuarios.addEventListener('change', function() {
                ...
                seleccionarTodosBtnText.innerHTML = this.checked ?
                    '<i class="fas fa-users mr-1"></i> Deseleccionar Todos' :
                    '<i class="fas fa-users mr-1"></i> Seleccionar Todos';
            });
            ...
            seleccionarTodasFechas.addEventListener('change', function() {
                ...
                seleccionarTodasFechasBtnText.innerHTML = this.checked ?
                    '<i class="fas fa-calendar-check mr-1"></i> Desel. Todas Fechas' :
                    '<i class="fas fa-calendar-check mr-1"></i> Sel. Todas Fechas';
            });
            ...
            seleccionarTodosVisito.addEventListener('change', function() {
                ...
                seleccionarTodosVisitoBtnText.innerHTML = this.checked ?
                    '<i class="fas fa-tractor mr-1"></i> Desel. Todos Visitó' :
                    '<i class="fas fa-tractor mr-1"></i> Sel. Todos Visitó';
            });
            ...
            seleccionarTodosBtn.addEventListener('click', function() {
                ...
                seleccionarTodosBtn.innerHTML = !allChecked ?
                    '<i class="fas fa-users mr-1"></i> Deseleccionar Todos' :
                    '<i class="fas fa-users mr-1"></i> Seleccionar Todos';
            });
            ...
            seleccionarTodasFechasBtn.addEventListener('click', function() {
                ...
                seleccionarTodasFechasBtn.innerHTML = !allChecked ?
                    '<i class="fas fa-calendar-check mr-1"></i> Desel. Todas Fechas' :
                    '<i class="fas fa-calendar-check mr-1"></i> Sel. Todas Fechas';
            });
            ...
            seleccionarTodosVisitoBtn.addEventListener('click', function() {
                ...
                seleccionarTodosVisitoBtn.innerHTML = !allChecked ?
                    '<i class="fas fa-tractor mr-1"></i> Desel. Todos Visitó' :
                    '<i class="fas fa-tractor mr-1"></i> Sel. Todos Visitó';
            });
            ...
            aplicarFechaGlobal.addEventListener('click', function() {
                const allEntradas = document.querySelectorAll(
                    'input[type="datetime-local"]:not(#fechaEntradaGlobal)');
