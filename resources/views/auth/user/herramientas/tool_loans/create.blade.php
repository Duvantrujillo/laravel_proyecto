@extends('layouts.Master') {{-- Preserving your layout name --}}
                ...
                <form action="{{ route('loans.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="full_name" id="full_name" class="form-control rounded-end" required
                                value="{{ old('full_name') }}" placeholder="Ingrese el nombre completo">
                        </div>
                        @error('full_name')
                    ...
                    <!-- Elemento -->
                    <div class="mb-4">
                        <label for="observation_id" class="form-label fw-bold">Herramienta</label>
                        <div class="input-group">
                            <span class="input-group-text bg-light"><i class="bi bi-tools"></i></span>
                            <select name="observation_id" id="observation_id" class="form-select rounded-end" required>
                                <option value="">-- Selecciona una herramienta --</option>
                                @foreach ($items as $item)
                                    @if ($item->amount > 0)
                                        <option value="{{ $item->id }}"
                                            {{ old('observation_id') == $item->id ? 'selected' : '' }}>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="requester_name" id="requester_name" class="form-control rounded-end"
                                required value="{{ old('requester_name') }}"
