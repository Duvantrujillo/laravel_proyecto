...
@endif
    ...
    <form class="elegant-form" action="{{ route('water_quality.store', $sowing->id) }}" method="POST">
        ...
        <div class="elegant-form-group">
            ...
            <input type="date" name="date" value="{{ old('date') }}" class="elegant-input" required>
            @error('date') <div class="elegant-error">{{ $message }}</div> @enderror
        </div>

        <div class="elegant-form-group">
            <label class="elegant-label">Hora</label>
            <input type="time" name="time" value="{{ old('time') }}" class="elegant-input" required>
        ...
        <div class="elegant-columns">
            <div class="elegant-column">
                <div class="elegant-form-group">
                    ...
                    <input type="number" step="0.01" name="ph" value="{{ old('ph') }}" class="elegant-input" required>
                    @error('ph') <div class="elegant-error">{{ $message }}</div> @enderror
                </div>

                <div class="elegant-form-group">
                    <label class="elegant-label">Temperatura (°C)</label>
                    <input type="number" step="0.01" name="temperature" value="{{ old('temperature') }}" class="elegant-input" required>
                    @error('temperature') <div class="elegant-error">{{ $message }}</div> @enderror
                </div>

                <div class="elegant-form-group">
                    <label class="elegant-label">Amonio (mg/L)</label>
                    <input type="number" step="0.01" name="ammonia" value="{{ old('ammonia') }}" class="elegant-input" required>
            ...
            <div class="elegant-column">
                <div class="elegant-form-group">
                    ...
                    <input type="number" step="0.01" name="turbidity" value="{{ old('turbidity') }}" class="elegant-input" required>
                    @error('turbidity') <div class="elegant-error">{{ $message }}</div> @enderror
                </div>

                <div class="elegant-form-group">
                    <label class="elegant-label">Oxígeno Disuelto (mg/L)</label>
                    <input type="number" step="0.01" name="dissolved_oxygen" value="{{ old('dissolved_oxygen') }}" class="elegant-input" required>
                    @error('dissolved_oxygen') <div class="elegant-error">{{ $message }}</div> @enderror
                </div>

                <div class="elegant-form-group">
                    <label class="elegant-label">Nitritos (mg/L)</label>
                    <input type="number" step="0.01" name="nitrites" value="{{ old('nitrites') }}" class="elegant-input" required>
        ...
        <div class="elegant-form-group">
            ...
            <input type="number" step="0.01" name="nitrates" value="{{ old('nitrates') }}" class="elegant-input" required>
