            ...
            <div class="col-md-10">
                ...
                <div class="card card-outline card-primary elevation-2" style="border-top: 3px solid #007bff;">
                    <div class="card-header bg-transparent border-0">
                        <h3 class="card-title text-dark"><i class="fas fa-water mr-2"></i> Gestión de Estanques y Geomembranas</h3>
                    </div>
                    <div class="card-body p-4">
                            ...
                            <div class="col-md-12">
                                ...
                                <form action="{{ route('geo.store') }}" method="post">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" placeholder="Nombre del estanque o geomembrana" required>
                                        @error('name')
                                            <span class="invalid-feedback d-block">{{ $message }}</span>
                                        @enderror
                                        <div class="input-group-append">
                                            <button type="submit" class="btn btn-primary" style="background: #007bff; border: none;">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h5 class="text-dark mb-3"><i class="fas fa-list-alt mr-1"></i> Seleccionar Estanque</h5>
                                <form action="{{ route('pond.store') }}" method="post">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" name="idficador" class="form-control @error('idficador') is-invalid @enderror" placeholder="Ingresa un número único" required>
                                                @error('idficador')
                                                    <span class="invalid-feedback d-block">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="pond_id" id="pond_id" class="form-control @error('pond_id') is-invalid @enderror" required>
                                    ...
                                    <!-- Botón de envío -->
                                    <button type="submit" class="btn btn-primary btn-block" style="background: #007bff; border: none;">
