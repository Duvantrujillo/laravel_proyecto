            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="elegant-actions">
                        <a href="{{ route('water_quality.edit', [$quality->id]) }}" class="elegant-button elegant-button--edit">Editar</a>
                        @auth
                        @if (Auth::user()->role === 'admin')
                        <form action="{{ route('water_quality.destroy', [$quality->id]) }}" method="POST" class="elegant-form-inline delete-form">
                            @csrf
                            @method('DELETE')
                            <button type="button" class="elegant-button elegant-button--delete show-confirm" data-id="{{ $quality->id }}">
                                Eliminar
                            </button>
                        </form>
                        @endif
