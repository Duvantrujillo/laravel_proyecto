...
@section('content')
    <style>
        /* [ESTILOS] los dejo igual para no repetir, ya están bien aplicados */
        .card {
            background: #ffffff;
            border-radius: 10px;
                        ...
                        <tbody>
                            @foreach ($sowing->dietMonitorings as $monitoring)
                                <tr>
                                    ...
                                    <td>{{ $monitoring->ration_number }} x {{ rtrim(rtrim(number_format($monitoring->ration, 2, '.', ''), '0'), '.') }} g</td>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Si hay pond_id cargado, disparamos el cambio automáticamente para cargar los identifiers
            if (pondSelect.value) {
