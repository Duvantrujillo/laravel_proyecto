                       ...
                       <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{route ('grupo-form')}}" class="nav-link text-danger">
                                            @csrf
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('register.create')}}" class="nav-link text-danger">
                                            @csrf
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{route('entrada_salida.create')}}" class="nav-link text-danger">
                                            @csrf
                                            <i class="nav-icon fas fa-edit"></i>
                                            <p>Registrar</p>
                                        </a>
